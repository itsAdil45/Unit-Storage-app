  ...
  return (
    <Tab.Navigator
      screenOptions={{
        ...
        tabBarStyle: {
          backgroundColor: dark ? darkColors.card : lightColors.card,
        },
        headerStyle: {
          backgroundColor: dark ? darkColors.card : lightColors.card,
        },
    ...
    >
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({ size }) => (
            <MaterialIcons name="dashboard" color={iconColor} size={size} />
          ),
        }}
      />
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({ size }) => (
            <MaterialIcons name="store" color={iconColor} size={size} />
          ),
        }}
      />
      <Tab.Screen
